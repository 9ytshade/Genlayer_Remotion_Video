...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "genlayer-remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgenlayer_remotion"] = self["webpackChunkgenlayer_remotion"] || [];
...
const tokens_COMP = {
  ...
  // 1.5s transition (slower)
  defaultSceneDuration: 180
  // 6s defaults
};
const SPACING = {
  xs: 8,
...
const s = (seconds) => Math.round(seconds * tokens_COMP.fps);
const scene = (startSec, durationSec) => ({
  from: s(startSec),
  durationInFrames: s(durationSec)
});

;// ./src/videos/videoConfig.ts
...
;// ./src/utils/interpolations.ts


const smoothIn = (frame, start, duration) => interpolate(frame, [start, start + duration], [0, 1], {
  extrapolateLeft: "clamp",
  extrapolateRight: "clamp",
  easing: Easing.out(Easing.cubic)
});
const smoothOut = (frame, start, duration) => interpolate(frame, [start, start + duration], [1, 0], {
  extrapolateLeft: "clamp",
  extrapolateRight: "clamp",
  easing: Easing.in(Easing.cubic)
});
const smoothInOut = (frame, enterStart, enterDuration, exitStart, exitDuration) => {
  const enter = smoothIn(frame, enterStart, enterDuration);
  const exit = smoothOut(frame, exitStart, exitDuration);
  return Math.min(enter, exit);
};
const slideUp = (frame, start, duration, distance = 40) => interpolate(frame, [start, start + duration], [distance, 0], {
  extrapolateLeft: "clamp",
  extrapolateRight: "clamp",
  easing: Easing.out(Easing.cubic)
});
const scaleIn = (frame, start, duration, from = 0.9) => interpolate(frame, [start, start + duration], [from, 1], {
  extrapolateLeft: "clamp",
  extrapolateRight: "clamp",
  easing: Easing.out(Easing.cubic)
});
const stagger = (index, delayPerItem = 5) => index * delayPerItem;
const seededRandom = (seed) => {
  const x = Math.sin(seed * 12.9898 + seed * 78.233) * 43758.5453;
  return x - Math.floor(x);
};
const seededRandomArray = (count, seed = 42) => {
...
;// ./src/animations/NeuralNetwork.tsx
...
const NeuralNetwork = ({
  ...
  const nodes = (0,react.useMemo)(() => {
    return Array.from({ length: nodeCount }, (_, i) => ({
      x: seededRandom(seed + i * 3) * tokens_COMP.width,
      y: seededRandom(seed + i * 3 + 1) * tokens_COMP.height,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { ...fullScreen, overflow: "hidden" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "svg",
    {
      width: tokens_COMP.width,
      height: tokens_COMP.height,
      viewBox: `0 0 ${tokens_COMP.width} ${tokens_COMP.height}`,
      style: fullScreen,
      children: [
        connections.map((conn, i) => {
          ...
          const opacity = (0,cjs.interpolate)(pulse, [-1, 1], [0.03, 0.15]) * intensity * (0,cjs.interpolate)(conn.dist, [0, 400], [1, 0.2]);
          const travelProgress = (frame * (0.3 + seededRandom(seed + i * 13) * 0.5) + seededRandom(seed + i * 17) * 300) % conn.dist / conn.dist;
        ...
        nodes.map((node, i) => {
          ...
          const opacity = (0,cjs.interpolate)(breath, [-1, 1], [0.3, 0.7]) * intensity;
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)("g", { children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "circle",
              {
...
;// ./src/animations/ParticleField.tsx
...
const ParticleField = ({
  ...
  const particles = (0,react.useMemo)(() => {
    return Array.from({ length: particleCount }, (_, i) => {
      const rand = (offset) => seededRandom(seed + i * 5 + offset);
      const layer = rand(0) < 0.2 ? "near" : rand(0) < 0.6 ? "mid" : "far";
      return {
        x: rand(1) * tokens_COMP.width,
        y: rand(2) * tokens_COMP.height,
        size: layer === "near" ? 2 + rand(3) * 2.5 : layer === "mid" ? 1 + rand(3) * 1.5 : 0.5 + rand(3) * 1,
        speed: (layer === "near" ? 0.8 : layer === "mid" ? 0.4 : 0.15) * speed,
        opacity: (layer === "near" ? 0.5 : layer === "mid" ? 0.3 : 0.12) * intensity,
        layer
      };
    });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { ...fullScreen, overflow: "hidden" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "svg",
    {
      ...
      style: fullScreen,
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("filter", { id: "particle-glow", children: [
        ...
        particles.map((p, i) => {
          const yOffset = frame * p.speed % tokens_COMP.height;
          const y = (p.y - yOffset + tokens_COMP.height) % tokens_COMP.height;
          ...
          const twinkle = Math.sin(
            frame * (0.05 + seededRandom(seed + i * 19) * 0.1) + seededRandom(seed + i * 23) * Math.PI * 2
          );
          const opacity = p.opacity * (0,cjs.interpolate)(twinkle, [-1, 1], [0.5, 1]);
          return /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "circle",
            {
              ...
              opacity,
              filter: p.layer === "near" ? "url(#particle-glow)" : void 0
            },
            i
          );
        })
...
;// ./src/animations/CameraDrift.tsx
...
const FilmGrain = ({ opacity = 0.04 }) => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { ...fullScreen, pointerEvents: "none" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "svg",
    {
      width: tokens_COMP.width,
      height: tokens_COMP.height,
...
const Layout = ({
  ...
  const content = /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      style: {
      ...
      children: [
        theme === "dark" && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...fullScreen,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          cjs.AbsoluteFill,
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              cjs.Img,
              {
                src: (0,cjs.staticFile)(watermarkLogo),
                style: {
                  width: "75%",
                  height: "auto",
                  objectFit: "contain",
                  filter: "blur(10px)"
                  // Restored original colors, kept blur
                }
              }
            )
          }
        ),
        showNeural && theme === "dark" && /* @__PURE__ */ (0,jsx_runtime.jsx)(NeuralNetwork, { intensity: neuralIntensity }),
        showParticles && theme === "dark" && /* @__PURE__ */ (0,jsx_runtime.jsx)(ParticleField, { intensity: particleIntensity }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.AbsoluteFill, { children }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              cjs.Img,
              {
                src: (0,cjs.staticFile)("assets/mochi/mochi.png"),
                style: { width: 120, height: 120, objectFit: "contain" }
              }
            )
          }
        ),
        showGrain && theme === "dark" && /* @__PURE__ */ (0,jsx_runtime.jsx)(FilmGrain, {}),
        showVignette && theme === "dark" && /* @__PURE__ */ (0,jsx_runtime.jsx)(Vignette, {})
      ]
    }
  );
  if (showDrift) {
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.AbsoluteFill, { style: { backgroundColor: theme === "light" ? "#FFFFFF" : COLORS.bgPrimary }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(CameraDrift, { children: content }) });
  }
  return content;
};
...
const { fontFamily: fonts_fontFamily } = loadFont();
const FONTS = {
  primary: "Inter",
  weights: {
    regular: 500,
...
;// ./src/animations/MaskedTextReveal.tsx
...
const MaskedTextReveal = ({
  ...
  const frame = (0,cjs.useCurrentFrame)();
  const progress = (0,cjs.interpolate)(
    frame,
    ...
    [0, 1],
    {
      extrapolateLeft: "clamp",
      extrapolateRight: "clamp",
      easing: cjs.Easing.out(cjs.Easing.cubic)
    }
  );
  const translateY = direction === "up" ? (0,cjs.interpolate)(progress, [0, 1], [fontSize * 1.2, 0]) : (0,cjs.interpolate)(progress, [0, 1], [-fontSize * 1.2, 0]);
  const clipProgress = (0,cjs.interpolate)(progress, [0, 1], [0, 100]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
      ...
      children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        "div",
        {
          style: {
            ...
            opacity: (0,cjs.interpolate)(progress, [0, 0.3, 1], [0, 1, 1]),
...
const TitleScene = ({
  ...
  const frame = (0,cjs.useCurrentFrame)();
  const logoOpacity = (0,cjs.interpolate)(frame, [10, 30], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const logoScale = (0,cjs.interpolate)(frame, [10, 30], [0.95, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const subtitleOpacity = (0,cjs.interpolate)(frame, [70, 90], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const subtitleY = (0,cjs.interpolate)(frame, [70, 90], [15, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const episodeOpacity = (0,cjs.interpolate)(frame, [5, 20], [0, 0.6], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const lineWidth = (0,cjs.interpolate)(frame, [50, 75], [0, 200], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
        episodeNumber && /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              position: "absolute",
        ...
        showLogo && /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                cjs.Img,
                {
                  src: (0,cjs.staticFile)(logoPath),
                  style: { height: logoHeight, objectFit: "contain" }
                }
              ),
              coBrandLogoPath && /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { color: theme === "light" ? "#000" : "#FFF", fontSize: 32, fontWeight: "bold" }, children: "\u2715" }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  cjs.Img,
                  {
                    src: (0,cjs.staticFile)(coBrandLogoPath),
  ...
  const renderText = () => {
    ...
    while (remaining.length > 0) {
      ...
      if (earliestMatch === null) {
        elements.push(/* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: remaining }, keyIndex++));
        break;
      }
      if (earliestMatch.index > 0) {
        elements.push(
          /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: remaining.slice(0, earliestMatch.index) }, keyIndex++)
        );
      }
...
const ContentSection = ({
  ...
  const headingExit = (0,cjs.interpolate)(frame, [exitStart + 15, exitStart + 25], [1, 0], { extrapolateRight: "clamp" });
  const headingOpacity = Math.min(1, headingExit);
  const imageExitOpacity = (0,cjs.interpolate)(frame, [exitStart + 10, exitStart + 30], [1, 0], { extrapolateRight: "clamp" });
  const imageEnterOpacity = (0,cjs.interpolate)(frame, [20, 45], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const imageOpacity = Math.min(imageEnterOpacity, imageExitOpacity);
  const imageScale = (0,cjs.interpolate)(frame, [20, 45], [0.95, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity: headingOpacity }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                MaskedTextReveal,
                {
                  text: heading,
                  startFrame: 5,
              ...
              bodyLines.map((line, i) => {
                const lineExitDelay = stagger(bodyLines.length - 1 - i, 5);
                const lineExit = (0,cjs.interpolate)(frame, [exitStart + lineExitDelay, exitStart + lineExitDelay + 10], [1, 0], { extrapolateRight: "clamp" });
                return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { opacity: lineExit }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  AccentText,
                  {
                    text: line,
                    highlights,
              ...
              bulletPoints && bulletPoints.length > 0 && /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
                    display: "flex",
                  ...
                  children: bulletPoints.map((point, i) => {
                    const bulletEnterOpacity = (0,cjs.interpolate)(
                      frame,
                      [
                        50 + stagger(i, 10),
                        65 + stagger(i, 10)
                    ...
                    const bulletExitOpacity = (0,cjs.interpolate)(frame, [exitStart - 10 + bulletExitDelay, exitStart + bulletExitDelay], [1, 0], { extrapolateRight: "clamp" });
                    const bulletOpacity = Math.min(bulletEnterOpacity, bulletExitOpacity);
                    const bulletX = (0,cjs.interpolate)(
                      frame,
                      [
                        50 + stagger(i, 10),
                        65 + stagger(i, 10)
        ...
        hasImage && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ...
          {
            style: {
              flex: imagePosition === "bottom" ? void 0 : 1,
              display: "flex",
              justifyContent: "center",
              alignItems: "center",
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              cjs.Img,
              {
                src: (0,cjs.staticFile)(imagePath),
                style: {
...
const SignalWave = ({
  ...
  const opacity = (0,cjs.interpolate)(progress, [0, 0.3, 1], [0, 0.8, 0]);
  const sweepX = progress * tokens_COMP.width * 1.2 - tokens_COMP.width * 0.1;
  const points = [];
  const waveHeight = 60;
  const segments = 200;
  for (let i = 0; i <= segments; i++) {
    const t = i / segments;
    const x = t * tokens_COMP.width;
    const distFromSweep = Math.abs(x - sweepX);
    const envelope = Math.max(
      0,
      1 - distFromSweep / (tokens_COMP.width * 0.15)
    );
    const y = tokens_COMP.height / 2 + Math.sin(t * 30 + frame * 0.3) * waveHeight * envelope;
    points.push(`${x},${y}`);
  }
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { ...fullScreen, pointerEvents: "none" }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "svg",
    {
      ...
      style: fullScreen,
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("filter", { id: "signal-glow", children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("feGaussianBlur", { stdDeviation: "6", result: "blur" }),
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("feMerge", { children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("feMergeNode", { in: "blur" }),
            /* @__PURE__ */ (0,jsx_runtime.jsx)("feMergeNode", { in: "SourceGraphic" })
          ] })
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("defs", { children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "linearGradient",
          {
            ...
            y2: "0",
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "0%", stopColor: color, stopOpacity: "0" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "50%", stopColor: color, stopOpacity: "1" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("stop", { offset: "100%", stopColor: color, stopOpacity: "0" })
            ]
          }
        ) })
      ]
...
;// ./src/components/ConceptReveal.tsx
...
const ConceptReveal = ({
  ...
  const frame = (0,cjs.useCurrentFrame)();
  const glowSize = (0,cjs.interpolate)(frame, [10, 60], [0, 120], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const glowOpacity = (0,cjs.interpolate)(frame, [10, 30, 80], [0, 0.4, 0.2], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const subtitleOpacity = (0,cjs.interpolate)(frame, [50, 70], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const subtitleY = (0,cjs.interpolate)(frame, [50, 70], [20, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const lineWidth = (0,cjs.interpolate)(frame, [25, 50], [0, 300], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(SignalWave, { triggerFrame: signalFrame, color: accentColor }),
        shouldShowLogos && Array.from({ length: logoCount }).map((_, i) => {
          const appearStart = 20 + i * 5;
          const appearEnd = appearStart + 15;
          const logoOpacity = (0,cjs.interpolate)(
            frame,
          ...
          const rotation = (0,cjs.interpolate)(
            frame,
            [0, 200],
            [0, 360],
            {
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
                    ...
                    opacity: (0,cjs.interpolate)(frame, [30, 45], [0, 1], {
                      extrapolateLeft: "clamp",
                      extrapolateRight: "clamp"
                    }),
        ...
        (subtitle || pills) && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              marginTop: SPACING.lg,
            ...
            children: pills ? /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", gap: SPACING.md, justifyContent: "center" }, children: pills.map((pill, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                style: {
                  backgroundColor: accentColor,
...
;// ./src/components/ComparisonScene.tsx
...
const ComparisonCard = ({ side, color, isRight, startFrame, pointDelay, theme = "dark" }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const opacity = (0,cjs.interpolate)(frame, [startFrame, startFrame + 18], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const translateX = (0,cjs.interpolate)(frame, [startFrame, startFrame + 18], [isRight ? 60 : -60, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const glowPulse = isRight ? (0,cjs.interpolate)(frame, [startFrame + 20, startFrame + 50, startFrame + 80], [0.4, 1, 0.4], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.inOut(cjs.Easing.sin)
  }) : 0;
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      style: {
        ...
        borderRadius: 20,
        overflow: "hidden",
        background: isRight ? `linear-gradient(135deg, ${color}15, ${color}05)` : theme === "light" ? "linear-gradient(135deg, #F9FAFB, #F3F4F6)" : "linear-gradient(135deg, #0d0d0d, #111118)",
      ...
      children: [
            ...
            children: [
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: side.headerLogoPath ? /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    cjs.Img,
                    {
                      src: (0,cjs.staticFile)(side.headerLogoPath),
                      style: {
                        height: 70,
                        width: "auto",
                        opacity: 1,
                    ...
                    side.headerIcon && /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontSize: 60 }, children: side.headerIcon }),
                    side.label && /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { children: side.label })
                  ] })
                }
              )
            ]
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { padding: `${SPACING.xl}px`, display: "flex", flexDirection: "column", gap: SPACING.md, flex: 1, justifyContent: "center" }, children: side.points.map((point, i) => {
          const pd = pointDelay + i * 8;
          const pOpacity = (0,cjs.interpolate)(frame, [pd, pd + 12], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp"
          });
          const pX = (0,cjs.interpolate)(frame, [pd, pd + 12], [isRight ? 16 : -16, 0], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: cjs.Easing.out(cjs.Easing.cubic)
          });
...
const ComparisonScene = ({ heading, left, right, theme = "dark" }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const leftColor = left.color || COLORS.textMuted;
  const rightColor = right.color || COLORS.accentPrimary;
  const vsOpacity = (0,cjs.interpolate)(frame, [28, 40], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(1.5))
  });
  const vsScale = (0,cjs.interpolate)(frame, [28, 40], [0.5, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(1.5))
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
        heading && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { textAlign: "center" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          MaskedTextReveal,
          {
            text: heading,
            startFrame: 0,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "stretch", gap: 0, flex: 1 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(ComparisonCard, { side: left, color: leftColor, isRight: false, startFrame: 10, pointDelay: 28, theme }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)(ComparisonCard, { side: right, color: rightColor, isRight: true, startFrame: 22, pointDelay: 45, theme })
        ] })
      ]
    }
  );
...
;// ./src/components/StatHighlight.tsx
...
const StatHighlight = ({
  ...
  const frame = (0,cjs.useCurrentFrame)();
  const progress = (0,cjs.interpolate)(frame, [10, 60], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  let displayValue = value;
  if (countUp && numericValue !== void 0) {
    const current = numericValue * progress;
    displayValue = current.toLocaleString(void 0, {
      minimumFractionDigits: 0,
      maximumFractionDigits: 1
    });
  }
  const pulse = Math.sin(frame * 0.06) * 0.3 + 0.7;
  const scale = (0,cjs.interpolate)(frame, [5, 30], [0.9, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(1.5))
  });
  const opacity = (0,cjs.interpolate)(frame, [5, 25], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const labelOpacity = (0,cjs.interpolate)(frame, [30, 50], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const labelY = (0,cjs.interpolate)(frame, [30, 50], [15, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
...
const MochiScene = ({
  ...
  const mochiX = (0,cjs.interpolate)(frame, [5, 30], [enterFrom, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(1.3))
  });
  const mochiOpacity = (0,cjs.interpolate)(frame, [5, 20], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const floatY = Math.sin(frame * 0.04) * 8;
  const bubbleOpacity = (0,cjs.interpolate)(frame, [30, 45], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const bubbleScale = (0,cjs.interpolate)(frame, [30, 45], [0.9, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(1.5))
  });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
        showBubble && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              flex: isCenter ? void 0 : 1,
              display: "flex",
                ...
                children: [
                  /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 8, height: 8, borderRadius: "50%", background: COLORS.accentSecondary } }),
                        /* @__PURE__ */ (0,jsx_runtime.jsx)(
                          "span",
                          {
                            style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              cjs.Img,
              {
                src: (0,cjs.staticFile)(mochiImage),
                style: {
                  width: 280,
                  height: 280,
                  objectFit: "contain",
...
const SocialPill = ({ label, color }) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
  "div",
  {
    style: {
      display: "flex",
...
;// ./src/components/ClosingScene.tsx
...
const ClosingScene = ({
  ...
  const logoScale = (0,cjs.interpolate)(frame, [10, 30], [0.9, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const taglineOpacity = (0,cjs.interpolate)(frame, [30, 50], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const taglineY = (0,cjs.interpolate)(frame, [30, 50], [20, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const linksOpacity = (0,cjs.interpolate)(frame, [60, 80], [0, 0.7], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const mochiOpacity = (0,cjs.interpolate)(frame, [40, 60], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              poweredByLogoPath && /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { marginTop: SPACING.md, display: "flex", alignItems: "center", gap: SPACING.sm }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { fontFamily: FONTS.primary, fontSize: 16, color: theme === "light" ? "#666" : COLORS.textMuted }, children: "Powered by" }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Img, { src: (0,cjs.staticFile)(poweredByLogoPath), style: { height: 24, objectFit: "contain" } })
              ] })
            ]
          }
        ),
        ...
        showMochi && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              opacity: mochiOpacity,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(SocialPill, { label: "genlayer.com", color: "#3B82F6" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(SocialPill, { label: "@GenLayer", color: "#1DA1F2" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(SocialPill, { label: "discord.gg/genlayer", color: "#5865F2" })
            ]
          }
        )
      ]
...
;// ./src/transitions/TransitionEngine.tsx
...
const SceneTransition = ({
  ...
  const frame = (0,cjs.useCurrentFrame)();
  const entryOpacity = transitionIn > 0 ? (0,cjs.interpolate)(frame, [0, transitionIn], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  }) : 1;
  const entryScale = transitionIn > 0 ? (0,cjs.interpolate)(frame, [0, transitionIn], [0.98, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  }) : 1;
...
const SceneSequence = ({ scenes }) => {
  let currentFrame = 0;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.AbsoluteFill, { children: scenes.map((scene) => {
...
;// ./src/animations/EnergyBuild.tsx
...
const EnergyBuild = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: children(energy) });
};
const useEnergyFactor = (totalFrames = tokens_COMP.durationInFrames) => {
  const frame = (0,cjs.useCurrentFrame)();
  const linear = (0,cjs.interpolate)(frame, [0, totalFrames], [0, 1], {
    extrapolateRight: "clamp"
  });
  return 0.2 + 0.8 * (linear * linear);
};

;// ./src/videos/Video01_WhatIsGenLayer.tsx
...
const Video01_WhatIsGenLayer = () => {
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    Layout,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(0), durationInFrames: s(5), name: "title", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(5), transitionOut: 12, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          TitleScene,
          {
            title: "What is GenLayer?",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(5), durationInFrames: s(12), name: "blockchain-landscape", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(12), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ContentSection,
          {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(17), durationInFrames: s(8), name: "concept-intelligent-contracts", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(8), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ConceptReveal,
          {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(25), durationInFrames: s(15), name: "comparison", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ComparisonScene,
          {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(40), durationInFrames: s(15), name: "capabilities", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ContentSection,
          {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(55), durationInFrames: s(8), name: "concept-genvm", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(8), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ConceptReveal,
          {
            term: "GenVM",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(63), durationInFrames: s(15), name: "optimistic-democracy", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ContentSection,
          {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(78), durationInFrames: s(10), name: "concept-optimistic-democracy", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(10), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          ConceptReveal,
          {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(88), durationInFrames: s(12), name: "stats", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(12), children: /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          cjs.AbsoluteFill,
          {
            style: {
              display: "flex",
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "relative", width: 400, height: 300 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                StatHighlight,
                {
                  value: "7.5",
                  prefix: "$",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(100), durationInFrames: s(12), name: "mochi", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(12), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          MochiScene,
          {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(112), durationInFrames: s(8), name: "closing", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(8), transitionIn: 15, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ClosingScene, {}) }) })
      ]
    }
  );
};

;// ./src/videos/Video02_WhyGenLayerExists.tsx
...
const Video02_WhyGenLayerExists = () => {
  const energy = useEnergyFactor(s(120));
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(Layout, { neuralIntensity: energy, particleIntensity: energy, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(0), durationInFrames: s(5), name: "title", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(5), transitionOut: 12, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      TitleScene,
      {
        title: "Why Does GenLayer Exist?",
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(5), durationInFrames: s(15), name: "vending-machine", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ContentSection,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(20), durationInFrames: s(15), name: "upgrade", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ContentSection,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(35), durationInFrames: s(8), name: "concept-nondeterministic", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(8), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ConceptReveal,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(43), durationInFrames: s(15), name: "why-now", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ContentSection,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(58), durationInFrames: s(15), name: "comparison", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ComparisonScene,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(73), durationInFrames: s(15), name: "examples", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ContentSection,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(88), durationInFrames: s(15), name: "mochi", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      MochiScene,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(103), durationInFrames: s(17), name: "closing", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(17), transitionIn: 15, transitionOut: 0, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(ClosingScene, {}) }) })
  ] });
};

;// ./src/videos/Video03_IntelligentContracts.tsx
...
const Video03_IntelligentContracts = () => {
  const energy = useEnergyFactor(s(120));
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(Layout, { neuralIntensity: energy, particleIntensity: energy, children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(0), durationInFrames: s(5), name: "title", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(5), transitionOut: 12, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      TitleScene,
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(5), durationInFrames: s(15), name: "recap", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ContentSection,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(20), durationInFrames: s(8), name: "concept-capabilities", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(8), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ConceptReveal,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(28), durationInFrames: s(15), name: "capability-search", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ContentSection,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(43), durationInFrames: s(15), name: "capability-decide", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ContentSection,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(58), durationInFrames: s(15), name: "capability-language", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ContentSection,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: s(73), durationInFrames: s(15), name: "how-it-works", children: /* @__PURE__ */ (0,jsx_runtime.jsx)(SceneTransition, { durationInFrames: s(15), children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      ContentSection,
      {
...
const Video04_GenVM = () => {
  const energy = useEnergyFactor(s(120));
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(Layout, { neuralIntensity: energy, particleIntensity: energy, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    SceneSequence,
    {
      scenes: [
        {
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(ClosingScene, {})
        }
      ]
    }
  ) });
...
;// ./src/videos/Video05_OptimisticDemocracy.tsx
...
const Video05_OptimisticDemocracy = () => {
  const energy = useEnergyFactor(s(120));
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(Layout, { neuralIntensity: energy, particleIntensity: energy, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    SceneSequence,
    {
...
;// ./src/videos/Video06_EquivalencePrinciple.tsx
...
const Video06_EquivalencePrinciple = () => {
  const energy = useEnergyFactor(s(120));
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(Layout, { neuralIntensity: energy, particleIntensity: energy, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    SceneSequence,
    {
...
;// ./src/videos/Video07_IntelligentOracles.tsx
...
const Video07_IntelligentOracles = () => {
  const energy = useEnergyFactor(s(120));
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(Layout, { neuralIntensity: energy, particleIntensity: energy, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    SceneSequence,
    {
...
;// ./src/components/IconGridScene.tsx
...
const IconGridScene = ({
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { textAlign: "center", width: "100%" }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          MaskedTextReveal,
          {
            text: heading,
            startFrame: 5,
          ...
          "div",
          {
            ...
            children: items.map((item, i) => {
              ...
              const opacity = (0,cjs.interpolate)(
                ...
                [delay, delay + 15],
                [0, 1],
                { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: cjs.Easing.out(cjs.Easing.cubic) }
              );
              const translateY = (0,cjs.interpolate)(
                frame,
                [delay, delay + 15],
              ...
              const scale = (0,cjs.interpolate)(
                ...
                [delay, delay + 15],
                [0.85, 1],
                { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: cjs.Easing.out(cjs.Easing.back(1.5)) }
              );
              ...
              return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 52, lineHeight: 1 }, children: item.emoji }),
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        style: {
                    ...
                    item.sublabel && /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        style: {
                          fontFamily: FONTS.primary,
...
;// ./src/videos/Video09_UseCases.tsx
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentSecondary,
              items: [
                { emoji: "\u{1F4F0}", label: "Reads the news", sublabel: "AP, Reuters, BBC \u2014 checked instantly", color: COLORS.accentSecondary },
                { emoji: "\u26A1", label: "Instant Settlement", sublabel: "No manual review process", color: COLORS.accentPrimary },
                { emoji: "\u{1F517}", label: "On-chain Truth", sublabel: "Verified by validator consensus", color: COLORS.accentTertiary },
                { emoji: "\u{1F6AB}", label: "No Oracles Needed", sublabel: "Contract reads the web directly", color: COLORS.accentSecondary }
              ]
            }
          )
        },
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentTertiary,
              items: [
                { emoji: "\u{1F33E}", label: "Drought Insurance", sublabel: "Farmers protected automatically", color: COLORS.accentTertiary },
                { emoji: "\u{1F4E1}", label: "NOAA Data", sublabel: "Contract checks weather daily", color: COLORS.accentPrimary },
                { emoji: "\u{1F4CB}", label: "No Paperwork", sublabel: "Zero claims process needed", color: COLORS.accentSecondary },
                { emoji: "\u{1F4B0}", label: "Auto Payout", sublabel: "Below threshold = instant payment", color: COLORS.accentTertiary }
              ]
            }
          )
        },
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentPrimary,
              items: [
                { emoji: "\u{1F4DC}", label: "AI Constitution", sublabel: "Reads proposals in any language", color: COLORS.accentPrimary },
                { emoji: "\u2705", label: "Auto-Votes", sublabel: "Enforces rules 24/7", color: COLORS.accentTertiary },
                { emoji: "\u{1F3E6}", label: "Treasury AI", sublabel: "Manages funds by market conditions", color: COLORS.accentSecondary }
              ]
            }
          )
        },
...
;// ./src/components/IdentityGapScene.tsx
...
const BridgeArrow = ({ startFrame }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const opacity = (0,cjs.interpolate)(frame, [startFrame, startFrame + 15], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const glow = (0,cjs.interpolate)(
    frame,
    [startFrame + 15, startFrame + 35, startFrame + 55],
    [0.4, 1, 0.4],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: cjs.Easing.inOut(cjs.Easing.sin) }
  );
  const dotOffset = (0,cjs.interpolate)(
    frame,
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { position: "relative", width: 80, height: 6, overflow: "hidden", borderRadius: 3 }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              position: "absolute",
...
const WalletCard = ({ startFrame }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const opacity = (0,cjs.interpolate)(frame, [startFrame, startFrame + 20], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const translateX = (0,cjs.interpolate)(frame, [startFrame, startFrame + 20], [-60, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: SPACING.md }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { children: [
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsx)(
              "div",
              {
                ...
                children: "Wallet Only"
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { height: 1, background: `${COLORS.textMuted}20` } }),
        rows.map((row, i) => {
          const rowDelay = startFrame + 20 + i * 6;
          const rowOpacity = (0,cjs.interpolate)(frame, [rowDelay, rowDelay + 10], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp"
          });
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                ...
                /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "div",
                  {
                    style: {
                      ...
                      color: row.value === "????" || row.value === "None" || row.value === "Unknown" || row.value === "0" ? `${COLORS.textMuted}60` : COLORS.textMuted,
                      fontWeight: FONTS.weights.bold
                    },
                    children: row.value
                  }
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: "Who are you in crypto?"
          }
        )
      ]
    }
...
const IdentityCard = ({ startFrame }) => {
  ...
  const borderGlow = (0,cjs.interpolate)(
    frame,
  ...
  const socials = [
    { emoji: "\u{1D54F}", handle: "@alex_builds", color: COLORS.textPrimary },
    { emoji: "\u{1F4BB}", handle: "github/alexbuilds", color: COLORS.accentTertiary },
    { emoji: "\u{1F4BC}", handle: "LinkedIn \xB7 4 yrs exp", color: COLORS.accentSecondary }
  ];
  const rows = [
    ...
    "div",
    {
      ...
      children: [
        ...
        socials.map((s, i) => {
          ...
          const sOpacity = (0,cjs.interpolate)(frame, [delay, delay + 12], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp"
          });
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 22, width: 30, textAlign: "center" }, children: s.emoji }),
                /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "div",
                  {
                    style: {
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { height: 1, background: `${COLORS.accentPrimary}30` } }),
        rows.map((row, i) => {
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)(WalletCard, { startFrame: 15 }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(BridgeArrow, { startFrame: 40 }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(IdentityCard, { startFrame: 25 })
            ]
          }
        ),
        (() => {
          const tagOpacity = (0,cjs.interpolate)(frame, [80, 100], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp"
          });
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                ...
                " ",
                /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: COLORS.accentPrimary, fontWeight: FONTS.weights.bold }, children: "without giving up privacy?" })
              ]
            }
          );
        })()
...
;// ./src/videos/Video10_DecentralizedIdentity.tsx
...
const Video10_DecentralizedIdentity = () => {
  const energy = useEnergyFactor(s(120));
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(Layout, { neuralIntensity: energy, particleIntensity: energy, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    SceneSequence,
    {
      scenes: [
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(IdentityGapScene, {})
        },
        {
          id: "concept",
          durationInFrames: s(8),
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentPrimary,
              items: [
                { emoji: "\u{1F426}", label: "Post a Code", sublabel: "Share a verification code on Twitter/X", color: COLORS.accentSecondary },
                { emoji: "\u{1F50D}", label: "Contract Reads It", sublabel: "Intelligent Contract fetches the tweet", color: COLORS.accentPrimary },
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentSecondary,
              items: [
                { emoji: "\u{1F4B3}", label: "Credit Scores", sublabel: "Lending based on social history", color: COLORS.accentPrimary },
                { emoji: "\u{1F5F3}\uFE0F", label: "One Person, One Vote", sublabel: "Sybil-proof governance systems", color: COLORS.accentSecondary },
                { emoji: "\u{1F91D}", label: "Social Recovery", sublabel: "Restore wallets using trusted friends", color: COLORS.accentTertiary },
                { emoji: "\u{1F916}", label: "Bot Proof", sublabel: "Only real humans get access", color: COLORS.accentPrimary },
                { emoji: "\u{1F381}", label: "Fair Airdrops", sublabel: "Check account age automatically", color: COLORS.accentSecondary },
                { emoji: "\u{1F512}", label: "Privacy First", sublabel: "No passport or KYC required", color: COLORS.accentTertiary }
              ]
            }
          )
        },
...
;// ./src/components/TimelineScene.tsx
...
const TimelineScene = ({
  ...
  const pathLength = 4e3;
  const roadProgress = (0,cjs.interpolate)(frame, [10, 180], [pathLength, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.bezier(0.4, 0, 0.2, 1)
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "absolute", top: 40, width: "100%", textAlign: "center", zIndex: 100 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            MaskedTextReveal,
            {
              text: heading,
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { height: 4, width: 180, background: accentColor, margin: "15px auto" } })
        ] }),
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width: "1920", height: "1080", viewBox: "0 0 1920 1080", style: { position: "absolute", top: 0, left: 0 }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "path",
            {
              d: pathD,
        ...
        steps.map((step, i) => {
          ...
          const nodeScale = (0,cjs.interpolate)(frame, [delay, delay + 15], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: cjs.Easing.back(1.5)
          });
          const contentOpacity = (0,cjs.interpolate)(frame, [delay + 12, delay + 25], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp"
          });
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
              ...
              alignItems: "center",
              justifyContent: "center"
            }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 68, filter: "drop-shadow(0 4px 6px rgba(0,0,0,0.1))" }, children: step.emoji || i + 1 }) }) }),
            /* @__PURE__ */ (0,jsx_runtime.jsxs)("svg", { width: "600", height: "200", style: {
              position: "absolute",
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)("circle", { cx: isRight ? 0 : 450, cy: "60", r: "8", fill: stepColor })
            ] }),
            /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
              position: "absolute",
              left: isRight ? node.x - 550 : node.x + 180,
              top: node.y - 120,
              width: 380,
...
;// ./src/videos/Video11_AutonomousDAOs.tsx
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentSecondary,
              items: [
                { emoji: "\u{1F550}", label: "Weeks to Decide", sublabel: "Voting is painfully slow", color: COLORS.textMuted },
                { emoji: "\u{1F634}", label: "Low Participation", sublabel: "Most token holders never vote", color: COLORS.textMuted },
                { emoji: "\u{1F3DB}\uFE0F", label: "Just Multisigs", sublabel: "Controlled by a few humans", color: COLORS.textMuted }
              ]
            }
          )
        },
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentPrimary,
              items: [
                { emoji: "\u{1F331}", label: "Carbon-Neutral Check", sublabel: "AI reviews project whitepapers before releasing funds", color: COLORS.accentTertiary },
                { emoji: "\u{1F6AB}", label: "Auto-Moderation", sublabel: "Reject hate speech proposals automatically", color: COLORS.accentSecondary },
                { emoji: "\u26A1", label: "Instant Micro-Decisions", sublabel: "Routine ops happen without any vote", color: COLORS.accentPrimary },
                { emoji: "\u{1F9E0}", label: "Reads the Internet", sublabel: "Checks news, data, market conditions live", color: COLORS.accentTertiary }
              ]
            }
          )
        },
...
;// ./src/components/StatCounterScene.tsx
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
          ...
          "div",
          {
            ...
            children: stats.map((stat, i) => {
              ...
              const scale = (0,cjs.interpolate)(
                ...
                [delay, delay + 18],
                [0.6, 1],
                { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: cjs.Easing.out(cjs.Easing.back(1.2)) }
              );
              const glowPulse = (0,cjs.interpolate)(
                frame,
              ...
              return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
                "div",
                {
                  ...
                  children: [
                    ...
                    stat.sublabel && /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        style: {
                          fontFamily: FONTS.primary,
        ...
        bodyText && (() => {
          const bodyOpacity = (0,cjs.interpolate)(frame, [60, 80], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: cjs.Easing.out(cjs.Easing.cubic)
          });
...
;// ./src/videos/Video12_Reliability.tsx
...
;// ./src/components/LanguageWarsScene.tsx
...
const CodeLine = ({ line, frame, startFrame, isSolidity }) => {
  const opacity = (0,cjs.interpolate)(frame, [startFrame, startFrame + 8], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const translateX = (0,cjs.interpolate)(frame, [startFrame, startFrame + 8], [isSolidity ? -16 : 16, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  ...
  const color = isComment ? COLORS.textMuted : isSolidity ? COLORS.textSecondary : COLORS.textPrimary;
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
...
const CodePanel = ({ title, badge, lines, startFrame, isSolidity, borderColor, bgColor }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const opacity = (0,cjs.interpolate)(frame, [startFrame, startFrame + 18], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  ...
  const translateX = (0,cjs.interpolate)(frame, [startFrame, startFrame + 18], [isSolidity ? -50 : 50, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const glowPulse = isSolidity ? 0 : (0,cjs.interpolate)(
    frame,
    [startFrame + 20, startFrame + 50, startFrame + 80],
    [0.5, 1, 0.5],
    { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: cjs.Easing.inOut(cjs.Easing.sin) }
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", gap: 8 }, children: ["#FF5F56", "#FFBD2E", "#27C93F"].map((c, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 14, height: 14, borderRadius: "50%", background: isSolidity ? `${c}60` : c } }, i)) }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
                fontFamily: FONTS.primary,
                fontSize: FONTS.sizes.caption,
                fontWeight: FONTS.weights.bold,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: lines.map((line, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
              CodeLine,
              {
                line,
                frame,
...
const LanguageWarsScene = () => {
  const frame = (0,cjs.useCurrentFrame)();
  const vsOpacity = (0,cjs.interpolate)(frame, [30, 45], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const vsScale = (0,cjs.interpolate)(frame, [30, 45], [0.5, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(2))
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { display: "flex", gap: SPACING.xl, flex: 1, alignItems: "stretch" }, children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
            CodePanel,
            {
              title: "Token.sol",
          ...
          /* @__PURE__ */ (0,jsx_runtime.jsxs)(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { width: 2, flex: 1, background: `linear-gradient(180deg, ${COLORS.accentSecondary}40, transparent)` } })
              ]
            }
          ),
          /* @__PURE__ */ (0,jsx_runtime.jsx)(
        ...
        (() => {
          const labelOpacity = (0,cjs.interpolate)(frame, [85, 100], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp"
          });
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
            ...
            " ",
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: COLORS.accentTertiary, fontWeight: FONTS.weights.bold }, children: "if you know Python, you are already a GenLayer developer." })
          ] });
        })()
      ]
    }
...
;// ./src/videos/Video13_PythonCode.tsx
    ...
    SceneSequence,
    {
      scenes: [
        ...
        },
        {
          id: "intro",
          durationInFrames: s(18),
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(LanguageWarsScene, {})
        },
        {
          id: "concept",
          durationInFrames: s(8),
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentTertiary,
              items: [
                { emoji: "\u{1F40D}", label: "Python Native", sublabel: "Import standard libraries. Use familiar syntax.", color: COLORS.accentTertiary },
                { emoji: "\u{1F916}", label: "AI Prompts in Code", sublabel: "Mix `if x > 10` with `if sentiment is positive`", color: COLORS.accentPrimary },
                { emoji: "\u{1F310}", label: "Web Access Built-in", sublabel: "Call any URL directly from your contract", color: COLORS.accentSecondary }
              ]
            }
          )
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentPrimary,
              items: [
                { emoji: "\u{1F9EA}", label: "Test Locally", sublabel: "Run contracts before deploying to network", color: COLORS.accentPrimary },
                { emoji: "\u{1F3AD}", label: "Mock AI Responses", sublabel: "Simulate LLM outputs deterministically", color: COLORS.accentTertiary },
                { emoji: "\u{1F504}", label: "Code \u2192 Simulate \u2192 Deploy", sublabel: "Rapid iteration cycle with instant feedback", color: COLORS.accentSecondary }
              ]
            }
          )
        },
...
;// ./src/videos/Video14_UniqueApproach.tsx
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              items: [
                { emoji: "\u{1F3AD}", label: "Just Wrappers", sublabel: 'Most "AI crypto" wraps OpenAI APIs', color: COLORS.textMuted },
                { emoji: "\u{1F4A5}", label: "Single Point of Failure", sublabel: "If OpenAI goes down, your dApp breaks", color: COLORS.accentSecondary },
                { emoji: "\u{1F6AB}", label: "Not Truly Decentralized", sublabel: "Corporate servers control the intelligence", color: COLORS.textMuted }
              ]
            }
          )
        },
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentPrimary,
              items: [
                { emoji: "\u{1F5A5}\uFE0F", label: "Local Models", sublabel: "Validators run open-source models on their own hardware", color: COLORS.accentTertiary },
                { emoji: "\u{1F513}", label: "No Permission Needed", sublabel: "Intelligence that can't be turned off", color: COLORS.accentPrimary },
...
;// ./src/components/CollisionScene.tsx
...
const SideCard = ({
  ...
  const translateX = (0,cjs.interpolate)(frame, [startFrame, startFrame + 20], [fromLeft ? -70 : 70, 0], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 80, lineHeight: 1, filter: `drop-shadow(0 0 ${16 * glowPulse}px ${color})` }, children: emoji }),
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
            fontFamily: FONTS.primary,
            fontSize: FONTS.sizes.h3,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { display: "flex", flexWrap: "wrap", gap: SPACING.sm, justifyContent: "center" }, children: tags.map((tag, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              fontFamily: FONTS.primary,
...
const CollisionCenter = ({ startFrame }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const plusOpacity = (0,cjs.interpolate)(frame, [startFrame, startFrame + 12], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const equalsOpacity = (0,cjs.interpolate)(frame, [startFrame + 20, startFrame + 35], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const equalsScale = (0,cjs.interpolate)(frame, [startFrame + 20, startFrame + 35], [0.5, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(1.5))
  });
  ...
  const rotation = (0,cjs.interpolate)(frame, [startFrame, startFrame + 120], [0, 360], {
    extrapolateLeft: "clamp",
    extrapolateRight: "extend"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { position: "relative", width: 80, height: 80 }, children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
                  position: "absolute",
                  inset: 0,
                  borderRadius: "50%",
                ...
                /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
                  ...
                  cjs.Img,
                  {
                    src: (0,cjs.staticFile)("assets/logos/GenLayer_Logo_White_Cropped.png"),
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(CollisionCenter, { startFrame: 35 }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                SideCard,
                {
                  emoji: "\u{1F517}",
...
;// ./src/videos/Video15_FutureOfAI.tsx
    ...
    SceneSequence,
    {
      scenes: [
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(CollisionScene, {})
        },
        {
          id: "concept",
          durationInFrames: s(8),
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              items: [
                ...
                { emoji: "\u{1F3E6}", label: "The Bank", sublabel: "Trustless settlement without intermediaries", color: COLORS.accentTertiary },
                { emoji: "\u{1F91D}", label: "The Marketplace", sublabel: "Machine-to-machine economy worth trillions", color: COLORS.accentSecondary }
              ]
            }
          )
        },
...
;// ./src/components/ValidatorConsensusScene.tsx
...
const VALIDATORS = [
  { label: "Validator A", emoji: "\u{1F5A5}\uFE0F" },
  { label: "Validator B", emoji: "\u{1F4BB}" },
  { label: "Validator C", emoji: "\u{1F5A5}\uFE0F" },
  { label: "Validator D", emoji: "\u{1F4BB}" },
  { label: "Validator E", emoji: "\u{1F5A5}\uFE0F" }
];
const ValidatorNode = ({ emoji, label, voteFrame, nodeFrame, accentColor, theme = "dark" }) => {
  const frame = (0,cjs.useCurrentFrame)();
  const nodeOpacity = (0,cjs.interpolate)(frame, [nodeFrame, nodeFrame + 12], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.cubic)
  });
  const nodeScale = (0,cjs.interpolate)(frame, [nodeFrame, nodeFrame + 12], [0.6, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(1.5))
  });
  const hasVoted = frame >= voteFrame;
  const voteOpacity = (0,cjs.interpolate)(frame, [voteFrame, voteFrame + 10], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(2))
  });
  const voteScale = (0,cjs.interpolate)(frame, [voteFrame, voteFrame + 10], [0.3, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(2))
  });
  const glowPulse = hasVoted ? (0,cjs.interpolate)(frame, [voteFrame + 10, voteFrame + 30, voteFrame + 50], [0.5, 1, 0.5], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.inOut(cjs.Easing.sin)
  }) : 0;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      ...
      children: [
        hasVoted && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              position: "absolute",
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              height: 100,
              borderRadius: "50%",
              background: hasVoted ? `radial-gradient(circle, ${accentColor}40, ${accentColor}15)` : `${theme === "light" ? "#E5E7EB" : COLORS.textMuted}15`,
...
const ValidatorConsensusScene = ({
  ...
  const stampOpacity = (0,cjs.interpolate)(frame, [allVotedFrame, allVotedFrame + 18], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(1.5))
  });
  const stampScale = (0,cjs.interpolate)(frame, [allVotedFrame, allVotedFrame + 18], [1.4, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.out(cjs.Easing.back(1.5))
  });
  const stampGlow = (0,cjs.interpolate)(frame, [allVotedFrame + 18, allVotedFrame + 40, allVotedFrame + 62], [0.5, 1, 0.5], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
    easing: cjs.Easing.inOut(cjs.Easing.sin)
  });
  const linesOpacity = (0,cjs.interpolate)(frame, [55, 70], [0, 0.4], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    cjs.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { textAlign: "center", width: "100%", marginBottom: SPACING.lg }, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
          MaskedTextReveal,
          {
            text: title,
            startFrame: 3,
        ...
        (() => {
          const subOpacity = (0,cjs.interpolate)(frame, [18, 28], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp"
          });
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
            ...
            " ",
            /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: { color: COLORS.accentPrimary, fontWeight: FONTS.weights.bold }, children: "immutable" }),
            "."
          ] });
        })(),
        (() => {
          const factOpacity = (0,cjs.interpolate)(frame, [30, 44], [0, 1], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: cjs.Easing.out(cjs.Easing.cubic)
          });
          const factY = (0,cjs.interpolate)(frame, [30, 44], [20, 0], {
            extrapolateLeft: "clamp",
            extrapolateRight: "clamp",
            easing: cjs.Easing.out(cjs.Easing.cubic)
          });
          return /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
            ...
            /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 32, flexShrink: 0 }, children: "\u{1F4F0}" }),
            /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
                fontFamily: FONTS.primary,
                fontSize: FONTS.sizes.caption,
                ...
                letterSpacing: 2,
                marginBottom: 4
              }, children: "Fact submitted for verification" }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
                fontFamily: "monospace",
                fontSize: FONTS.sizes.body,
                color: theme === "light" ? "#000" : COLORS.textPrimary
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              ...
              VALIDATORS.map((v, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
                ValidatorNode,
                {
                  emoji: v.emoji,
                  label: v.label,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 48 }, children: "\u26D3\uFE0F" }),
              /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { children: [
                /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "div",
                  {
                ...
                /* @__PURE__ */ (0,jsx_runtime.jsx)(
                  "div",
                  {
                    ...
                    children: "5/5 validators agreed \xB7 Consensus reached \xB7 Immutable on-chain"
                  }
                )
              ] }),
              /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { fontSize: 48 }, children: "\u2705" })
            ]
          }
        )
      ]
...
;// ./src/videos/Video16_TrustInAI.tsx
    ...
    SceneSequence,
    {
      scenes: [
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.textMuted,
              items: [
                { emoji: "\u{1F3AD}", label: "Deepfakes", sublabel: "AI-generated video of anyone saying anything", color: COLORS.textMuted },
                { emoji: "\u{1F4F0}", label: "Fake News", sublabel: "AI-written articles indistinguishable from real", color: COLORS.textMuted },
                { emoji: "\u{1F916}", label: "AI Spam Bots", sublabel: "Flooding the internet with synthetic content", color: COLORS.textMuted }
              ]
            }
          )
        },
        ...
        },
        {
          id: "solution",
          durationInFrames: s(18),
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(ValidatorConsensusScene, {})
        },
        {
          id: "humanity",
          durationInFrames: s(15),
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentSecondary,
              items: [
                { emoji: "\u{1F9D1}", label: "Prove You're Human", sublabel: "Decentralized identity \u2014 no centralized KYC", color: COLORS.accentSecondary },
                { emoji: "\u{1F310}", label: "Web of Trust", sublabel: "Social graph on-chain, Bot-proof communities", color: COLORS.accentPrimary },
                { emoji: "\u{1F510}", label: "Cryptographic Proof", sublabel: "The only anchor in a world of synthetic media", color: COLORS.accentTertiary }
              ]
            }
          )
        },
...
;// ./src/videos/Video17_TenReasons.tsx
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentPrimary,
              items: [
                { emoji: "\u{1F310}", label: "1. No Oracles", sublabel: "Native internet access built-in", color: COLORS.accentPrimary },
                { emoji: "\u{1F40D}", label: "2. Python Dev", sublabel: "World's largest developer community", color: COLORS.accentSecondary },
                { emoji: "\u{1F5F3}\uFE0F", label: "3. Optimistic Democracy", sublabel: "Subjective consensus that works", color: COLORS.accentTertiary },
                { emoji: "\u{1F512}", label: "4. Unstoppable AI", sublabel: "Sovereign intelligence, no kill switch", color: COLORS.accentPrimary },
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentTertiary,
              items: [
                { emoji: "\u{1F4CA}", label: "6. New DeFi Primitives", sublabel: "Insurance, Prediction Markets on-chain", color: COLORS.accentSecondary },
                { emoji: "\u{1F3DB}\uFE0F", label: "7. Autonomous DAOs", sublabel: "Self-governing organizations", color: COLORS.accentTertiary },
                { emoji: "\u{1FAAA}", label: "8. Decentralized Identity", sublabel: "Social graph on the blockchain", color: COLORS.accentPrimary },
                { emoji: "\u{1F916}", label: "9. AI Commerce", sublabel: "The machine-to-machine economy", color: COLORS.accentSecondary },
                { emoji: "\u{1F9E0}", label: "10. First Intelligent Chain", sublabel: "A blockchain that can think", color: COLORS.accentPrimary }
              ]
            }
          )
        },
...
;// ./src/videos/Video18_Roadmap.tsx
              ...
              steps: [
                {
                  ...
                  title: "Asimov \xB7 Local Testnet",
                ...
                {
                  label: "Phase 2 \u2014 Live Now \u{1F534}",
                  title: "Bradbury \xB7 Public Testnet",
              ...
              steps: [
                {
                  ...
                  title: "Clarke \xB7 Incentivized Testnet",
...
;// ./src/videos/Video19_Partnerships.tsx
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              items: [
                ...
                { emoji: "\u{1F504}", label: "Caldera", sublabel: "Rollup-as-a-service infrastructure", color: COLORS.accentSecondary },
                { emoji: "\u{1F4E1}", label: "Atoma", sublabel: "Network availability and data verification", color: COLORS.accentTertiary }
              ]
            }
          )
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentTertiary,
              items: [
                { emoji: "\u{1F5A5}\uFE0F", label: "io.net", sublabel: "Decentralized compute for training models", color: COLORS.accentPrimary },
                { emoji: "\u{1F5FD}", label: "LibertAI", sublabel: "Open source AI agents and developer tooling", color: COLORS.accentSecondary },
                { emoji: "\u{1F9E0}", label: "Gaia", sublabel: "Decentralized AI knowledge bases", color: COLORS.accentTertiary }
              ]
            }
          )
        },
...
;// ./src/videos/Video20_OpenToAll.tsx
  ...
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    cjs.AbsoluteFill,
    {
      ...
      children: lines.map((line, i) => {
        const delay = i * 18;
        const opacity = (0,cjs.interpolate)(frame, [delay, delay + 20], [0, 1], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp",
          easing: cjs.Easing.out(cjs.Easing.cubic)
        });
        const translateY = (0,cjs.interpolate)(frame, [delay, delay + 20], [30, 0], {
          extrapolateLeft: "clamp",
          extrapolateRight: "clamp",
          easing: cjs.Easing.out(cjs.Easing.cubic)
        });
        ...
        return /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            style: {
              ...
              lineHeight: 1.2,
              textShadow: isAccent ? `0 0 60px ${COLORS.accentPrimary}60, 0 0 120px ${COLORS.accentPrimary}30` : "none"
            },
            children: line
          },
          i
    ...
    SceneSequence,
    {
      scenes: [
        ...
        },
        {
          ...
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            IconGridScene,
            {
              ...
              accentColor: COLORS.accentPrimary,
              items: [
                { emoji: "\u{1F48E}", label: "Ethereum DeFi", sublabel: "Protocol uses GenLayer for AI risk scores", color: COLORS.accentSecondary },
                { emoji: "\u{1F3AE}", label: "Solana Gaming", sublabel: "NPC dialogue powered by GenLayer intelligence", color: COLORS.accentTertiary },
                { emoji: "\u{1F310}", label: "Any Chain", sublabel: "GenLayer exports intelligence everywhere", color: COLORS.accentPrimary }
              ]
            }
          )
        },
        ...
        },
        {
          id: "closing",
          durationInFrames: s(15),
          component: /* @__PURE__ */ (0,jsx_runtime.jsx)(ClosingScene, { tagline: "The Intelligent Future is Here" })
        }
      ]
    }
  ) });
...
;// ./src/videos/Special01_InternetCourt.tsx
            ...
            },
            {
              ...
              component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                TimelineScene,
                {
                  ...
                  theme: "light",
                  steps: [
                    { label: "Step 1", title: "Created", description: "A binary claim is filed.", emoji: "\u{1F4C4}", color: IC_THEME.primary },
                    { label: "Step 2", title: "Active", description: "Parties agree to the process.", emoji: "\u26D3\uFE0F", color: IC_THEME.secondary },
                    { label: "Step 3", title: "Disputed", description: "Evidence constraints are submitted.", emoji: "\u{1F50D}", color: IC_THEME.tertiary },
                    { label: "Step 4", title: "Resolving", description: "AI jury analyzes data.", emoji: "\u{1F9E0}", color: IC_THEME.secondary },
            ...
            },
            {
              ...
              component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                ComparisonScene,
                {
                  ...
                  right: {
                    label: "",
                    // Label hidden when logo is provided
            ...
            },
            {
              ...
              component: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                IconGridScene,
                {
                  ...
                  theme: "light",
                  items: [
                    { emoji: "\u{1F4B0}", label: "Faster & Cheaper", sublabel: "Beats slow human jury models", color: IC_THEME.primary },
                    { emoji: "\u{1F4C8}", label: "Infinitely Scalable", sublabel: "Resolves thousands of cases instantly", color: IC_THEME.secondary },
                    { emoji: "\u{1F916}", label: "AI-Native", sublabel: "No token politics or human boundaries", color: IC_THEME.tertiary },
                    { emoji: "\u{1F680}", label: "Essential Infrastructure", sublabel: "Every autonomous platform needs this", color: IC_THEME.primary }
                  ]
                }
              )
            },
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
              cjs.Img,
              {
                src: (0,cjs.staticFile)("assets/logos/Genlayer-noBG.png"),
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            style: {
              position: "absolute",
              top: 280,
              // Moved down from 150 to avoid logo overlap
              bottom: 150,
              left: SPACING.xl,
              right: SPACING.xl,
              display: "flex",
            ...
            children: [
                    ...
                    /* @__PURE__ */ (0,jsx_runtime.jsx)(
                      "div",
                      {
                        ...
                        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                          cjs.Img,
                          {
                            src: (0,cjs.staticFile)("assets/pfp/9ytshade.png"),
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: showMochi && /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    cjs.Img,
                    {
                      src: (0,cjs.staticFile)("assets/mochi/mochi.png"),
                      style: {
...
const RemotionRoot = () => {
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, { children: [
    ...
    VIDEO_CONFIG.map((video) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
      cjs.Composition,
      {
